...
// source is low ass trailer (~100mb)
sourceA = new VideoSource(renderer, {src: "/streamable/pnwuty"});
sourceB = new VideoSource(renderer, {src: "/streamable/g7zwfh"});
sourceC = new VideoSource(renderer, {src: "/streamable/g74ssz"});
...
if ( window.mobileAndTabletCheck() ) {
  ...
  sourceA = new VideoSource(renderer, {src: "/streamable/rfbomb"});
  sourceB = new VideoSource(renderer, {src: "/streamable/g58ezg"});
  sourceC = new VideoSource(renderer, {src: "/streamable/6x8ks9"});
}
*/
...
document.getElementById('mobile_button').onclick = function() {
  setQuality("mobile")
  document.getElementById('mobile_button').classList.add('selected')
...
document.getElementById('sd_button').onclick = function() {
  setQuality("SD")
  document.getElementById('mobile_button').classList.remove('selected')
...
var setQuality = function(_quality) {
  ...
  console.log("set quality: ", _quality)
  if (_quality == "mobile")  {
    sourceA.src("/streamable/pnwuty");
    sourceB.src("/streamable/g7zwfh");
    sourceC.src("/streamable/g74ssz");

  } else if (_quality == "HD")  {
    sourceA.src("/streamable/rfbomb");
    sourceB.src("/streamable/g58ezg");
    sourceC.src("/streamable/6x8ks9");
