...
// create some solids 
var source1 = new VideoSource(renderer, { src: "/streamable/zjbbgs" })
var source2 = new VideoSource(renderer, { src: "/streamable/v0hpnc" }) 
var source3 = new VideoSource(renderer, { src: "/streamable/y97gt6" })
...
filemanager.load_set("/sets/occupy_chaos_streamable.json")

var filemanager2 = new FileManager( source2 )
filemanager2.load_set("/sets/occupy_chaos_streamable.json")

var filemanager3 = new FileManager( source3 )
filemanager3.load_set("/sets/programs_runner_streamable.json")
