...
function replace_rules( _str ) {  
  if (_str.indexOf("streamable") != -1) {
    _str = _str.replace('streamable', 'streamable_thumbnail')
    return _str 
  }
...
loadSetOntoElement( '/sets/programs_awesome_streamable.json', elm('thumbnails_a'), 'jump_a', "change_a" )
loadSetOntoElement( '/sets/programs_runner_streamable.json', elm('thumbnails_b'), 'jump_b', "change_b" )
